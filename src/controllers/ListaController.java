...
public class ListaController<TIPO> {
	public class IteradorConcreto implements Lista<TIPO>{
		private No noAtual;
	...
	public Lista<TIPO> getInicio() {
		Lista<TIPO> i = new IteradorConcreto(inicio);
		return i;
	}
	
	public Lista<TIPO> getFim() {
